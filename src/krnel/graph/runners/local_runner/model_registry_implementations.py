...
import httpx
from krnel.graph.types import JSONColumnType, TextColumnType
import numpy as np
...
class HuggingFaceProvider(ModelProvider):
    ...
    def _process_batches(self, log, inputs, op, output_hidden_states):
        ...
        if isinstance(op.text, JSONColumnType) and not op.apply_chat_template:
        ...
        for batch in tqdm(
            ...
            if op.apply_chat_template:
                if isinstance(op.text, JSONColumnType):
